    ...
    <section id="hero" className="min-h-screen flex flex-col relative px-4">
      ...
      <div className="flex-1 flex items-center justify-center pt-20 lg:pt-0">
        <div className="text-center space-y-8 fade-in">
          ...
          <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-audiowide text-red-500">We Build. We Solve. We Ship.</h2>

          <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">Build. Connect. Grow with YÄ~TSU Squad.</p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mt-12">
            ...
            <button className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-cyan-400 text-cyan-400 font-bold rounded-full neon-button hover:bg-cyan-400 hover:text-black transition-all duration-300 text-base sm:text-lg w-full sm:w-auto">
              JOIN OUR COMMUNITY
            </button>
          </div>
        </div>
